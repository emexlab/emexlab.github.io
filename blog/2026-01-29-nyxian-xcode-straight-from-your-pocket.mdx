...
<ImagePopup src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*SKo00NmiV-HzDT6qiFoYGg.png" alt="Nyxian running on iPadOS 26.x" />
...
<div className="horizontal-scroll">
    <ImagePopup src="https://miro.medium.com/v2/resize:fit:668/format:webp/1*bComURViz8pIjIFFq7AIVw.png" />
    <ImagePopup src="https://miro.medium.com/v2/resize:fit:668/format:webp/1*NH7SynK5RHOvB4Re93nFtw.png" />
    <ImagePopup src="https://miro.medium.com/v2/resize:fit:668/format:webp/1*MCBwLPa7FOAfWJqB6pLWTw.png" alt="Nyxian running on iOS 26.x" />
</div>
