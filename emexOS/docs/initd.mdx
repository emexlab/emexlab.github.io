...
(ep is short for emex package). if you want to start programms in the background, not after each other then use `-bg`. to see how to create apps, read the article [how to create applications](create_applications)
